...
class ReportAPIController extends AppBaseController
{
    ...
    /**
     * Relatório de vendas por marca (com filtro de período).
     */
    public function getSalesByBrandReport(Request $request): JsonResponse
    {
    ...
    public function getProductQuantity(Request $request): JsonResponse
    {
        ...
        $product->map(function ($stock) {
        $stock->product_unit_name = $stock->product->getProductUnitName();
        return $stock;
    });
