                    ...
                    @foreach ($services as $service)
                        <div>
                            <div
                                ...
                                <div class="pb-5">
                                    <div
                                        class="lg:w-[92px] lg:h-[92px] sm:w-[80px] sm:h-[80px] w-[60px] h-[60px] rounded-full bg-primary flex justify-center items-center mx-auto mb-4 sm:shadow-[6px_3px_0_0_#ba010170] shadow-[5px_2px_0_0_#ba010170]">
