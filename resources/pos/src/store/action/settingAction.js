import { adminApiBaseURL, apiBaseURL, settingActionType, toastType } from "../../constants";
...
export const fetchCacheClear = (isAdmin = false) => async (dispatch) => {
    apiConfig
        .get(isAdmin ? adminApiBaseURL.CLEAR_CACHE : apiBaseURL.CACHE_CLEAR)
        .then((response) => {
            dispatch(
                addToast({
                    text: getFormattedMessage(
