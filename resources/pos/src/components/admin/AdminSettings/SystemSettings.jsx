...
const SystemSettings = ({ fetchAdminSettings, adminSetting, updateAdminSettings, fetchCurrencies, currencies, fetchCacheClear }) => {
...
export default connect(mapStateToProps, { fetchAdminSettings, updateAdminSettings, fetchCurrencies, fetchCacheClear })(SystemSettings);
