...
const WarehouseDetail = () => {
    ...
    return (
        <MasterLayout>
            ...
            <HeaderTitle title={getFormattedMessage('warehouse.details.title')} to='/app/user/warehouse' button={true} handleBackButton={handleBackButton} />
                                    ...
                                    <tr key={index}>
                                        ...
                                        <td>
                                            <div className="d-flex flex-wrap justify-content-start">
                                                <div className="badge bg-light-info me-2 mb-2">
                                                    <span>{item.quantity}</span>
                                                </div>
                                                <span className="badge bg-light-success me-2 mb-2">
                                                    <span>
